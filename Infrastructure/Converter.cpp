...
namespace Fractals::Infrastructure
{
    ...
    SharedString Converter::ToString(const VkBool32 bool_)
    {
		static const auto false_ = MAKE_SHARED_STRING("false");
		static const auto true_ = MAKE_SHARED_STRING("true");

		return bool_ > 0 ? true_ : false_;
    }
}